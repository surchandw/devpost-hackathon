import type { ReadPreferenceFromOptions, ReadPreferenceLike, OperationOptions, RunCommandCursor, RunCursorCommandOptions, ClientEncryptionOptions, MongoClient, MongoMissingDependencyError, SearchIndexDescription, TopologyDescription } from 'mongodb';
import type { ServiceProvider, ReplPlatform, ShellAuthOptions, AggregateOptions, AggregationCursor, AnyBulkWriteOperation, AnyClientBulkWriteModel, BulkWriteOptions, BulkWriteResult, ClientBulkWriteResult, ClientBulkWriteOptions, ClientSessionOptions, Collection, CountDocumentsOptions, CountOptions, CreateCollectionOptions, CreateIndexesOptions, FindCursor, Db, DbOptions, DeleteOptions, DeleteResult, DistinctOptions, Document, DropCollectionOptions, DropDatabaseOptions, EstimatedDocumentCountOptions, FindOneAndDeleteOptions, FindOneAndReplaceOptions, FindOneAndUpdateOptions, FindOptions, IndexDescription, InsertManyResult, InsertOneOptions, InsertOneResult, ListCollectionsOptions, ListDatabasesOptions, ListIndexesOptions, MongoClientOptions, ReadConcern, RenameOptions, ReplaceOptions, RunCommandOptions, ClientSession, UpdateOptions, UpdateResult, WriteConcern, ChangeStreamOptions, ChangeStream, AutoEncryptionOptions, ClientEncryption as MongoCryptClientEncryption, ConnectionInfo } from '@mongosh/service-provider-core';
...
export declare class NodeDriverServiceProvider extends ServiceProviderCore implements ServiceProvider {
    static connect(this: typeof NodeDriverServiceProvider, uri: string, driverOptions: DevtoolsConnectOptions, cliOptions?: {
        nodb?: boolean;
    }, bus?: MongoshBus): Promise<NodeDriverServiceProvider>;
    ...
    constructor(mongoClient: MongoClient, bus: MongoshBus, clientOptions: DevtoolsConnectOptions, uri?: ConnectionString, lastSeenTopology?: TopologyDescription);
    static getVersionInformation(): DependencyVersionInfo;
    static maybeThrowBetterMissingOptionalDependencyError(err: MongoMissingDependencyError): never;
    private static connectMongoClient;
    getNewConnection(uri: string, options?: Partial<DevtoolsConnectOptions>): Promise<NodeDriverServiceProvider>;
    _getHostnameForConnection(topology?: TopologyDescription): string | undefined;
    ...
    static processDriverOptions(currentProviderInstance: NodeDriverServiceProvider | null, uri: ConnectionString, opts: DevtoolsConnectOptions): DevtoolsConnectOptions;
    ...
    createSearchIndexes(database: string, collection: string, specs: SearchIndexDescription[], dbOptions?: DbOptions): Promise<string[]>;
    dropSearchIndex(database: string, collection: string, indexName: string, dbOptions?: DbOptions): Promise<void>;
    updateSearchIndex(database: string, collection: string, indexName: string, definition: SearchIndexDescription, dbOptions?: DbOptions): Promise<void>;
