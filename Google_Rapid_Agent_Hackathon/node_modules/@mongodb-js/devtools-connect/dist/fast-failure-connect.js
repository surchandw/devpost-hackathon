...
exports.isPotentialTLSCertificateError = exports.isFastFailureConnectionError = exports.COMPASS_SOCKET_SERVICE_NON_RETRY_CODES = void 0;
exports.COMPASS_SOCKET_SERVICE_NON_RETRY_CODES = [
    3000,
    3003,
    4004,
    1008,
...
function handleNestedErrors(fn) {
    const checker = (err) => {
        if (!Object.prototype.toString.call(err).match(/\[object .*error\]/i)) {
