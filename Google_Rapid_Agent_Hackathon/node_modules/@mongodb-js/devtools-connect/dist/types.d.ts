...
export interface ConnectEventMap extends MongoDBOIDCLogEventsMap, ProxyEventMap {
    ...
    'devtools-connect:tunnel-error': (ev: {
        error: Error;
    }) => void;
    'devtools-connect:tunnel-forwarding-error': (ev: {
        error: Error;
    }) => void;
}
